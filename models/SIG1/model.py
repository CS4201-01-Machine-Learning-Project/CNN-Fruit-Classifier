#srun -A bchn-delta-gpu --time=01:00:00 --nodes=1 --tasks-per-node=16 --partition=gpuA100x4,gpuA40x4 --gpus=1 --mem=64g --pty /bin/bash
import re
import os
import numpy as np
...
model = models.Sequential([
    ...
    layers.Conv2D(32,3,activation='sigmoid',input_shape=(100,100,3)),
...
model.save("SIGMOID_Model1.keras", save_format="keras")